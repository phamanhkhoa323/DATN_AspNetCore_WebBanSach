...
namespace DATN_AspNetCore_WebBanSach.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new DATN_AspNetCore_WebBanSachUser { FullName= Input.FullName,Birthday=Input.Birthday,Address=Input.Address, UserName = Input.Email, Email = Input.Email };
